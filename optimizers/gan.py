...
class GraphGANOptimizer(object):
    ...
    def __init__(self,
        ...
        with tf.name_scope('train_step'):
            ...
            gvs = self.train_step_D_opt.compute_gradients(
            ...
            capped_gvs = [(tf.clip_by_value(grad, -100, 100), var) for grad, var in gvs]  # 梯度裁剪
            ...
            gvs = self.train_step_V_opt.compute_gradients(
                loss=self.loss_V,
